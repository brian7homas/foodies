            ...
            <div class="recipe-archive__wrapper" >
                    <?php 
                        ...
                        <a href="<?php the_permalink()?>">
                            <div id="<?php echo the_ID();?>" class="recipe-archive__item" style="background-repeat:no-repeat;background-image: linear-gradient(to left bottom, rgba(27, 67,50, .5), rgba(82, 183, 136, 1)),url('<?php echo get_field('image')['sizes']['thumbnail'];?>');">
