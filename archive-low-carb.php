...
<div class="page" data-barba="container" data-barba-namespace="archive">
    <div class="page__wrapper" >
        <?php echo pageHeader(array(
            'title' => 'Low carb',
            'subTitle' => 'Recipes that that are low carb.'
        )); ?>
            ...
            <div class="recipe-archive__wrapper" >
                    <?php 
                        ...
                        <a href="<?php the_permalink()?>">
                            <div id="<?php echo the_ID();?>" class="recipe-archive__item" style="background-repeat:no-repeat;background-image: linear-gradient(to bottom, rgba(27, 67,50, .2), rgba(82, 183, 136, 1)),url('<?php echo get_field('image')['sizes']['thumbnail'];?>');">
