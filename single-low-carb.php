...
<div class="single-recipe"  data-barba="container" data-barba-namespace="single">
    <div class="single-recipe__wrapper"  >
        <div class="single-recipe__img" style="background-repeat:no-repeat;background-image: linear-gradient(to bottom, rgba(27, 67,50, .2), rgba(82, 183, 136, 1)),url('<?php echo $img['sizes']['contentLandscape'];?>');">
